...
MultiAccessSizeMem<4* 2048 * 1024, false> MainRAM;
...
static void PSX_Reset(bool powering_up)
{
 ...
 memset(MainRAM.data8, 0, 4 * 2048 * 1024);
...
static MDFN_COLD void InitCommon(std::vector<CDInterface*> *CDInterfaces, const bool IsPSF = false, const bool WantPIOMem = false)
{
 ...
 for(uint32 ma = 0x00000000; ma < 0x00800000; ma += 4 * 2048 * 1024)
 {
  CPU->SetFastMap(MainRAM.data8, 0x00000000 + ma, 4 * 2048 * 1024);
  CPU->SetFastMap(MainRAM.data8, 0x80000000 + ma, 4 * 2048 * 1024);
  CPU->SetFastMap(MainRAM.data8, 0xA0000000 + ma, 4 * 2048 * 1024);
 }
...
static void StateAction(StateMem *sm, const unsigned load, const bool data_only)
{
 ...
 SFORMAT StateRegs[] =
 {
  SFPTR8(MainRAM.data8, 4* 1024 * 2048),
